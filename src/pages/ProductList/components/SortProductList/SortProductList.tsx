    ...
    <div className="bg-gray-300/40 py-4 px-3 ">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center flex-wrap gap-2">
          ...
          <select
            className={classNames(
              "h-8 px-4 capitalize btext-sm  outline-none text-black cursor-pointer",
              {
                "bg-orange text-white hover:bg-orange/80": isActiveSortBy(
                  sortBy.price
                ),
          ...
          >
            ...
            <option
              ...
              className=" text-black hover:bg-orange/80 bg-white "
            >
              Giá: Thấp đến cao
            </option>
            <option
              value={orderConstant.desc}
              className="bg-white text-black hover:bg-orange/80 "
            >
              Giá: Cao đến thấp
            </option>
          </select>
