...
export default function ProductDetail() {
    ...
    const handleZoom = (
        ...
        // Cách 2: Lấy offsetX, offsetY khi chúng ta không xử lý được bubble
                ...
                <div className="bg-white p-4 shadow">
                    <div className="grid grid-cols-12 gap-9">
                                ...
                                {currentImages.map((img) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            />
                                            {isAcTive && (
                                                <div className="absolute inset-0 border-2 border-orange cursor-pointer"></div>
                                            )}
                                        </div>
                                    );
                                })}
                        ...
                        <div className="col-span-7">
                            ...
                            <div className="mt-6 flex items-center bg-gray-50 px-4 py-4">
